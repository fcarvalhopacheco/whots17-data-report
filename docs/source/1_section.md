...
Acoustic Doppler current profilers (ADCPs). See the WHOTS-17 mooring diagram in
the {numref}`diagram`.
...
```{figure} /figures/diagram/whots17-diagram.png
:height: 1000px
:align: center
:name: diagram
...
{ref}`III</3_section.md#description-of-WHOTS-17-mooring>` include a detailed

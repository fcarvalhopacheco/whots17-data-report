...
The WHOTS-17 mooring, 
deployed on August 26, 2021, 
...
COVID-19 pandemic. The WHOTS-17 
was recovered on 
July 25, 2022.
...
Instrumentation provided by UH for the WHOTS-17 mooring included 20 SBE-37
...
WHOTS-17 mooring subsurface instrument deployment information. All times 
are in UTC
```
...
{numref}`table-10`, and {ref}`/appendices.md#whots-17-300-khz-serial-4891` for
...
, {numref}`table-10`, and {ref}`/appendices.md#whots-17-600-khz-serial-1825`
...
All WHOTS-17 instruments were successfully recovered; recovery information for

...
panel), and 7215 (bottom panel), during the WHOTS-17 deployment. The light blue
...
VMCM and the 7-m MicroCAT temperatures during WHOTS-17, after adding a 0.0259°C 
...
21, 2020 (see {ref}`/3_section.md#description-of-whots-17-mooring`). For 
...
MicroCATs (lower panel) during the WHOTS-17 deployment. The light blue line is
...
between MicroCATs #12241 and #11391 during WHOTS-17. The blue (red) lines are
...
```{figure} figures/microcats/w17mic_corr8.jpg
:height: 1000px
:align: center
:name: figure5.15

Conductivity sensor correction for MicroCAT at 4713 meters during WHOTS-17
```
...
pre-deployment calibration. Results from the WHOTS-17 post-deployment ADCP
...
```{figure} figures/adcp_moored/adcp_whot17cmpserr_sn4891.png
:height: 600px
:align: center
:name: figure5.16
...
```{figure} figures/adcp_moored/adcp_whot17cmpserr_sn1825.png
:height: 600px
:align: center
:name: figure5.17
...
detailed in {ref}`/appendices.md#whots-17-300-khz-serial-4891`, and
{ref}`/appendices.md#whots-17-600-khz-serial-1825`. The salient differences for
...
WHOTS 
location. A heading bias of 9.54° was entered in the setup of the WHOTS-17 
ADCP’s.
...
4. An indication of data quality for each ensemble is given by the “percent
   ...
   {ref}`/appendices.md#whots-17-300-khz-serial-4891`). Data were flagged when
...
top during the WHOTS-17 deployment 
({ref}`/3_section.md#description-of-whots-17-mooring`). Data returns from the

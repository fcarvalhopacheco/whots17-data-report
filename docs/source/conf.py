...
# Make sure the explicitly target is unique
...
html_theme_options = {
    "repository_url": "https://github.com/hot-dogs/whots17-data-report",
...
epub_copyright = f"2023-01-06-{datetime.now().year}, Fernando Carvalho Pacheco"
